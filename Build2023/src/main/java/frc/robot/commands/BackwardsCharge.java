 ...
 *
 */
public class BackwardsCharge extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public BackwardsCharge(double position, Arm arm, Intake intake, DriveTrain drivetrain, Gyro gyro) {
