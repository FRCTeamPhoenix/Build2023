 ...
 *
 */
public class OldCubeHighChargeFurther extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public OldCubeHighChargeFurther(double position, Arm arm, Intake intake, DriveTrain drivetrain, Gyro gyro) {
