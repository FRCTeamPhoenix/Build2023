 ...
 *
 */
public class OnlyCharge extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public OnlyCharge(double position, Arm arm, Intake intake, DriveTrain drivetrain, Gyro gyro) {
    ...
    addCommands(
        ...
        // );
        new DriveDistanceTest(40, -0.8, drivetrain),
        new Charge(gyro,drivetrain).withTimeout(9)
    );
    }
