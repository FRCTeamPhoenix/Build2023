...
public class TurnDegrees extends CommandBase {
    ...
    public void execute() {
        ...
        m_driveTrain.turn(pid.calculate(m_gyro.getYaw(), m_angle));
        SmartDashboard.putNumber("Turn Speed", pid.calculate(m_gyro.getYaw(), m_angle));
        pid.setTolerance(0.5);
        pid.setIntegratorRange(-0.1, 0.1);
        atTarget = pid.atSetpoint();
        MathUtil.clamp(pid.calculate(m_gyro.getYaw(), m_angle), -0.5, 0.5);
