 ...
 *
 */
public class NoParallelCharge extends SequentialCommandGroup {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public NoParallelCharge(double position, Arm arm, Intake intake, DriveTrain drivetrain, Gyro gyro) {
