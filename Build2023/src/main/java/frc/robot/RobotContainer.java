...
btn_turnLeft.whileTrue(new TurnDegrees(90, 0.7, m_driveTrain, m_gyro).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
btn_turnRight.whileTrue(new TurnDegrees(90, -0.7, m_driveTrain, m_gyro).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
