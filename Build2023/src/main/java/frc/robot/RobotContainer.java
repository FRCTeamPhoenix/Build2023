...
private final XboxController xbox_driver = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("AutoScoreLow: position", new AutoScoreLow(-276, m_arm, m_intake));
    ...
    m_chooser.addOption("AutoScoreLow: position", new AutoScoreLow(-276, m_arm, m_intake));
