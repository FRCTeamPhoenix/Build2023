...
private final XboxController xbox_driver = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("AutoScoreLow: position", new AutoScoreLow(-276, m_arm, m_intake, m_driveTrain));
    SmartDashboard.putData("driveDistance: initial", new DriveDistance(0, 0, m_driveTrain));
    SmartDashboard.putData("AutoCone", new AutoCone(50, m_arm, m_intake, m_driveTrain));
    SmartDashboard.putData("AutoCube", new AutoCube(-92, m_arm, m_intake, m_driveTrain));
    SmartDashboard.putData("AutoCubeHigh", new AutoCubeHigh(-70, m_arm, m_intake, m_driveTrain));
    SmartDashboard.putData("AutoScoreLowCharge", new AutoScoreLowCharge( m_arm ));
    SmartDashboard.putData("AutoConeCharge", new AutoConeCharge( m_arm ));
    SmartDashboard.putData("AutoCubeCharge", new AutoCubeCharge( m_arm ));
    SmartDashboard.putData("AutoCubeHighCharge", new AutoCubeHighCharge( m_arm ));
    ...
    m_chooser.addOption("AutoScoreLow: position", new AutoScoreLow(-276, m_arm, m_intake, m_driveTrain));
    m_chooser.addOption("AutoCone", new AutoCone(-92, m_arm, m_intake, m_driveTrain));
    m_chooser.addOption("AutoCube", new AutoCube(-92, m_arm, m_intake, m_driveTrain));
    m_chooser.addOption("AutoCubeHigh", new AutoCubeHigh(-70, m_arm, m_intake, m_driveTrain));
    m_chooser.addOption("AutoScoreLowCharge", new AutoScoreLowCharge( m_arm ));
    m_chooser.addOption("AutoConeCharge", new AutoConeCharge( m_arm ));
    m_chooser.addOption("AutoCubeCharge", new AutoCubeCharge( m_arm ));
    m_chooser.addOption("AutoCubeHighCharge", new AutoCubeHighCharge( m_arm ));
