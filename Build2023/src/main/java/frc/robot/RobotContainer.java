...
private final XboxController xbox_driver = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("AutoScoreLowCharge", new AutoScoreLowCharge(-270, m_arm, m_intake, m_driveTrain, m_gyro));
    ...
    m_chooser.addOption("AutoScoreLowCharge", new AutoScoreLowCharge(-270, m_arm, m_intake, m_driveTrain, m_gyro));
