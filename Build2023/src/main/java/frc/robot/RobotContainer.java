...
private final XboxController xbox_driver = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("ResetDriveEncoders", new ResetDrive(m_driveTrain));
    // SmartDashboard.putData("ScorePosition", new ScorePosition( m_arm ));
    // SmartDashboard.putData("CubePosition", new CubePosition( m_arm ));
    // SmartDashboard.putData("AutoScoreLow: position", new AutoScoreLow(-257, m_arm, m_intake, m_driveTrain, m_gyro));
    // SmartDashboard.putData("driveDistance: initial", new DriveDistance(0, 0, m_driveTrain));
    // SmartDashboard.putData("AutoCone", new AutoCone(-145, m_arm, m_intake, m_driveTrain, m_gyro));
    // SmartDashboard.putData("AutoCube", new AutoCube(-145, m_arm, m_intake, m_driveTrain, m_gyro));
    // SmartDashboard.putData("AutoCubeHigh", new AutoCubeHigh(-75, m_arm, m_intake, m_driveTrain, m_gyro));
    ...
    m_chooser.addOption("0. DoubleBreak", new OldCubeHighChargeBreak(-70, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("01. Further", new OldCubeHighChargeFurther(-70, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("1. CubeHighCharge", new OldCubeHighCharge(-70, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("2. ConeCharge", new OldConeCharge(-78, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("3. CubeCharge", new OldCubeCharge(-88, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("4. ScoreLowCharge", new OldScoreLowCharge(-151, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("5. AutoCubeHigh", new AutoCubeHigh(-70, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("6. AutoCone", new AutoCone(-68, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("7. AutoCube", new AutoCube(-88, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("8. AutoScoreLow", new AutoScoreLow(-151, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("9. OnlyCharge", new OnlyCharge(-70, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("10. BackwardsCharge", new BackwardsCharge(-70, m_arm, m_intake, m_driveTrain, m_gyro));
    m_chooser.addOption("11. OnlyHighCube", new OnlyHighCube(-70, m_arm, m_intake, m_driveTrain, m_gyro));
    // m_chooser.addOption("10. NoParallelCharge", new NoParallelCharge(-70, m_arm, m_intake, m_driveTrain, m_gyro));
...
yellowLight.onTrue(new ColorChange("dark_orange") /*.withInterruptBehavior(InterruptionBehavior.kCancelSelf)*/);
