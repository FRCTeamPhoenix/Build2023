...
private CANSparkMax sm_motor_extend;
    ...
    private final double lowerMaximum = -276;
    private final double extendMaximum = 120;
    /**
    *
    */
    public Arm() {
...
sm_motor_extend.burnFlash();
    ...
    public boolean armToPosition (double d) {
        m_lift_pidController.setSmartMotionMaxVelocity(2000, 0);
        m_lift_pidController.setSmartMotionMinOutputVelocity(0, 0);
        m_lift_pidController.setSmartMotionMaxAccel(1500, 0);
